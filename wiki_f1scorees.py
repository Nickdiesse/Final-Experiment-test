...
cursor.execute("SELECT id, ground_truth, answer_llama, answer_orca, answer_falcon FROM wiki_esempionedb;")
...
for row in rows:
    ...
    cursor.execute("""
        INSERT INTO f1score_wiki_es (id, f1_llama, f1_orca, f1_falcon)
        VALUES (%s, %s, %s, %s);
