...
cursor.execute("SELECT question_id, ground_truth, answer_llama, answer_orca, answer_falcon FROM ragdb_esempione;")
...
for row in rows:
    ...
    cursor.execute("""
        INSERT INTO f1score_csv_es (id, f1_llama, f1_orca, f1_falcon)
        VALUES (%s, %s, %s, %s);
